#This finds the keystone index and its components. See
#Jordán, F., Takács-Sánta, A., & Molnár, I. (1999). A reliability theoretical quest for keystones. Oikos, 453-462.

keystone_indices = function(edge_list){

  setwd('/Users/ema/github/data_aggregation/r/food_web_tools/keystone_indices')
  data<-read.table("edgelist_8.txt", header=F)
  ...
  keystone_indices<-data.frame(nodeID,k,kbu,ktd,kdir,kindir)
  return(keystone_indices)
}
