function[clusterID,A_clusters]=bestClustering(A,branches,similarity)
...
something=rightNetwork(); %I need to fill this in
centrality_clusters=calculateCentrality(centrality);
