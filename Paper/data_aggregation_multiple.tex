...
\section*{Methods: clustering techniques}
	...
	\subsection*{Clustering of prey-based and predator-based modules}
		...
		We maximised this type of modules by using the R package rnetcarto \citep{Doulcier2015}. This finds the community structure of the network by using simulated annealing.  %CHANGE
...
\begin{appendices}
	...
	\label{appendix:c}
		%Here I should add the information about the food webs that I've used.
\end{appendices}
\end{document}
